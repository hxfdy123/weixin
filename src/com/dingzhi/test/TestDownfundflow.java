...
import com.dingzhi.util.HMACSHA256Uitl;
 ...
 * 项目名称：WeiXinPay  
 * 下载资金流对账单
 * 修改时间：2020年1月9日 上午10:59:20  
 */
public class TestDownfundflow {
			...
			public static void main(String[] args) throws UnsupportedOperationException, ClientProtocolException, IOException {
				Map<String,Object>map=new HashMap<String,Object>();
				  ...
				  // map.put("transaction_id", "");  //微信订单号 和商户订单号二选一传
				   ...
				   map.put("bill_date","20200109");  //账单日期
				   map.put("account_type","Basic");  //资金账号类型
				   String xml=XmlUtil.genXml(map);
				   System.out.println(xml);
				   InputStream in=HttpClientUtil.sendXMLDataByHttpsPost(url, xml).getEntity().getContent(); //发送xml消息;
